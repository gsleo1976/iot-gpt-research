...
| # | File | Description |
|---|------|-------------|
| 00 | [`docs/guides/00-learning-path.md`](docs/guides/00-learning-path.md) | 15-topic learning path across 4 phases — beginner to advanced, with direct links to free resources |
