...
Everything available in this repo at a glance:
...
| [`navigator.md`](navigator.md) | This file — full index of everything in the repository |
...
| File | Description |
|------|-------------|
| [`docs/IoT-GPT-Research-Proposal.docx`](docs/IoT-GPT-Research-Proposal.docx) | Full Word document research proposal — background, methodology, experiments, expected outcomes |
| [`docs/IoT-GPT-Beginner-Guide.docx`](docs/IoT-GPT-Beginner-Guide.docx) | Step-by-step hardware & software setup guide — Raspberry Pi, MQTT, sensors, InfluxDB, Grafana |
