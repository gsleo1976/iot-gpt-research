...
| # | File | Description |
|---|------|-------------|
| 01 | [`docs/guides/01-learning-path.md`](docs/guides/01-learning-path.md) | 15-topic learning path across 4 phases — beginner to advanced, with direct links to free resources |
| 02 | [`docs/guides/02-student-contribution-guide.md`](docs/guides/02-student-contribution-guide.md) | Student contribution guide — 12-week plan, hardware list with INR prices & Amazon India links, 5 experiments, full setup walkthrough |
